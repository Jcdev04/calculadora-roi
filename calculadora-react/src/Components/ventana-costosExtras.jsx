...
import {faChevronCircleLeft,faPenToSquare, faDollarSign, faCirclePlus, faTrash} from "@fortawesome/free-solid-svg-icons"
                            ...
                            <div style={CSS.boxCosto} className="boxCosto" key={i}>
                                <div>
                                    <section style={{display:"flex",marginTop:5}}>
                                        ...
                                        <input onChange={(e)=> handleChangeNombre(e.target.value,i)} value={data.nombreExtra} placeholder="Click aquí para escribir" className="nombreCostoExtra" style={{width:"100%", boxSizing: "border-box",marginBottom:2}} type="text"/>
                                    </section>
                                    <section style={{display:"flex", alignItems:"center"}}>
                                        <FontAwesomeIcon style={{ fontSize:16, color:"#05BE50", marginRight:15}} icon={faDollarSign}/>
